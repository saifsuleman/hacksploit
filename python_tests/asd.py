...
def getLoginData(args):
    ...
    burp0_headers = {"Connection": "close", "User-Agent": "...", "content-type": "application/json", "Accept": "*/*", "Origin": "https://accounts.firefox.com", "Sec-Fetch-Site": "same-site",
                     "Sec-Fetch-Mode": "cors", "Sec-Fetch-Dest": "empty", "Referer": "https://accounts.firefox.com/", "Accept-Encoding": "gzip, deflate", "Accept-Language": "en-US,en;q=0.9"}
    burp0_json = {"authPW": "...", "email": "...", "metricsContext": {"deviceId": "...", "entrypoint": "mozilla.org-firefox-accounts", "flowBeginTime": ..., "flowId": "...", "utmCampaign": "trailhead",
                                                                      "utmContent": "form-upper", "utmMedium": "referral", "utmSource": "mozilla.org-firefox-accounts"}, "reason": "signin", "resume": "...", "skipCaseError": True, "verificationMethod": "email-otp"}
